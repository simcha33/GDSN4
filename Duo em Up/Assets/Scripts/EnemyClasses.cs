...
public class Enemy
{
    ...
    public string tagName(Colors color)
    {
        if (color == Colors.colorless) return "EnemyNeutral";
        if (color == Colors.red) return "EnemyRed";
        if (color == Colors.blue) return "EnemyBlue";
        else return "EnemyNeutral";
    }
